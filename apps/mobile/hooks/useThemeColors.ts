...
const light = {
  ...
  accentLight:         lightTheme.background.accentLight,
  accentDarkOnSurface: lightTheme.foreground.accentDarkOnSurface,
  strokeAccent:        lightTheme.stroke.accent,
...
const dark = {
  ...
  accentLight:         darkTheme.background.accentLight,
  accentDarkOnSurface: darkTheme.foreground.accentDarkOnSurface,
  strokeAccent:        darkTheme.stroke.accent,
