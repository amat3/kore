      ...
      <Container>
        ...
        <HeadingRow ref={headingRef}>
          ...
          <HeaderActions>
            ...
            <StorybookLink
              href="https://6a1f429ec79df80605844468-bksvqzecdm.chromatic.com"
              target="_blank"
            ...
            <GlassLink
              href="https://6a1f429ec79df80605844468-bksvqzecdm.chromatic.com/?path=/story/kore-atoms-card--glass-on-scene"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <ShowcaseCanvas ref={showcaseRef} $isDark={isDark}>
          ...
          <DSBlock className="ds-block" $wide>
            ...
            <TypoList>
              ...
              <Text variant="body">
                Body · Una sesión para activar todo el cuerpo. Sin excusas, sin límites.
              </Text>
              <Text variant="body-light">
                Body Light · Disponible para nuevos proyectos y oportunidades.
              </Text>
              <Text variant="body-sm">
                Body Small · Diseñado para mujeres que entrenan con intención.
              </Text>
